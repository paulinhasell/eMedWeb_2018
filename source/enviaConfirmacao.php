...
$mail->MsgHTML($body);
	...
	if($mail->Send())
		...
		<div class='alert alert-danger semi' role='alert'><center><h1>Olá, $nome </h1>
				Voce recebera um e-mail para VALIDAR seu cadastro.<br/>
				Valide seu cadastro para garantir sua consulta com um especialista.<br/><br/>
                Somente CADASTROS CONFIRMADOS serao atendidos. Obrigado.<br><p class='semi center-block'>Equipe eMed</p>
                <p>IMPORTANTE - VERIFIQUE SUA CAIXA DE LIXO ELETRONICO ou SPAM caso o e-mail de validacao nao esteja na caixa de entrada</p>
                </center></div>";
	else
